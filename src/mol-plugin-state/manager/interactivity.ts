...
import type { StructureSelectionManager } from "./structure/selection.ts";
...
export type InteractivityFocusLociOptions =
  typeof DefaultInteractivityFocusOptions;
...
class InteractivityManager extends StatefulPluginComponent<InteractivityManagerState> {
  ...
  constructor(
    ...
    props: Partial<InteractivityManager.Props> = {},
  ) {
    super({
      props: { ...PD.getDefaultValues(InteractivityManager.Params), ...props },
    });

    this.lociSelects = new InteractivityManager.LociSelectManager(
      plugin,
      this._props,
    );
    this.lociHighlights = new InteractivityManager.LociHighlightManager(
      plugin,
      this._props,
    );
  }
...
namespace InteractivityManager {
  ...
  export abstract class LociMarkManager {
    ...
    constructor(
      public readonly ctx: PluginContext,
      props: Partial<Props> = {},
    ) {
