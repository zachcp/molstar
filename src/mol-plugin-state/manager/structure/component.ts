...
import { StateBuilder, StateObjectRef, StateTransformer } from '../../../mol-state.ts';
...
import { StructureRepresentationPresetProvider } from '../../builder/structure/representation-preset.ts';
