...
import { Ccp4File } from '../mol-io/reader/ccp4/schema.ts';
import { CifFile } from '../mol-io/reader/cif.ts';
import { DcdFile } from '../mol-io/reader/dcd/parser.ts';
import { Dsn6File } from '../mol-io/reader/dsn6/schema.ts';
import { PlyFile } from '../mol-io/reader/ply/schema.ts';
import { PsfFile } from '../mol-io/reader/psf/parser.ts';
...
import { Volume as _Volume } from '../mol-model/volume.ts';
...
import { VolumeRepresentation } from '../mol-repr/volume/representation.ts';
...
import { TopFile } from '../mol-io/reader/top/parser.ts';
...
export namespace PluginStateObject {
    ...
    export function CreateRepresentation3D<T extends Representation.Any, S = any>(
        type: { name: string },
    ) {
    ...
    export namespace Data {
        export class String
            extends Create<StringLike>({ name: 'String Data', typeClass: 'Data' }) {}
        export class Binary
            extends Create<Uint8Array>({ name: 'Binary Data', typeClass: 'Data' }) {}
    ...
    export namespace Format {
        ...
        export class Prmtop
            extends Create<PrmtopFile>({ name: 'PRMTOP File', typeClass: 'Data' }) {}
        ...
        export class Ccp4
            extends Create<Ccp4File>({ name: 'CCP4/MRC/MAP File', typeClass: 'Data' }) {}
    ...
    export namespace Molecule {
        export class Coordinates
            extends Create<_Coordinates>({ name: 'Coordinates', typeClass: 'Object' }) {}
        export class Topology
            extends Create<_Topology>({ name: 'Topology', typeClass: 'Object' }) {}
        export class Model extends Create<_Model>({ name: 'Model', typeClass: 'Object' }) {}
        export class Trajectory
            extends Create<_Trajectory>({ name: 'Trajectory', typeClass: 'Object' }) {}
        export class Structure
            extends Create<_Structure>({ name: 'Structure', typeClass: 'Object' }) {}

        export namespace Structure {
            export class Representation3D
                extends CreateRepresentation3D<StructureRepresentation<any>, _Structure>({
                    name: 'Structure 3D',
                }) {}
    ...
    export namespace Volume {
        ...
        export class Representation3D
            extends CreateRepresentation3D<VolumeRepresentation<any>, _Volume>({
                name: 'Volume 3D',
            }) {}
    }
    ...
    export namespace Shape {
        ...
        export class Representation3D
            extends CreateRepresentation3D<ShapeRepresentation<any, any, any>, unknown>({
                name: 'Shape 3D',
            }) {}
    }
}
