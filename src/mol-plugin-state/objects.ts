...
export namespace PluginStateObject {
    ...
    export namespace Data {
        export class String extends Create<StringLike>({
            name: 'String Data',
            typeClass: 'Data',
        }) {}
        export class Binary extends Create<Uint8Array<ArrayBuffer>>({
            name: 'Binary Data',
            typeClass: 'Data',
        }) {}
        ...
        export class Blob extends Create<BlobData>({
            name: 'Data Blob',
            typeClass: 'Data',
        }) {}
    }
    ...
    export namespace Format {
        export class Json extends Create<any>({
            name: 'JSON Data',
            typeClass: 'Data',
        }) {}
        export class Cif extends Create<CifFile>({
            name: 'CIF File',
            typeClass: 'Data',
        }) {}
        export class Cube extends Create<CubeFile>({
            name: 'Cube File',
            typeClass: 'Data',
        }) {}
        export class Psf extends Create<PsfFile>({
            name: 'PSF File',
            typeClass: 'Data',
        }) {}
        export class Prmtop extends Create<PrmtopFile>({
            name: 'PRMTOP File',
            typeClass: 'Data',
        }) {}
        export class Top extends Create<TopFile>({
            name: 'TOP File',
            typeClass: 'Data',
        }) {}
        export class Ply extends Create<PlyFile>({
            name: 'PLY File',
            typeClass: 'Data',
        }) {}
        export class Ccp4 extends Create<Ccp4File>({
            name: 'CCP4/MRC/MAP File',
            typeClass: 'Data',
        }) {}
        export class Dsn6 extends Create<Dsn6File>({
            name: 'DSN6/BRIX File',
            typeClass: 'Data',
        }) {}
        export class Dx extends Create<DxFile>({
            name: 'DX File',
            typeClass: 'Data',
        }) {}
    ...
    export namespace Molecule {
        export class Coordinates extends Create<_Coordinates>({
            name: 'Coordinates',
            typeClass: 'Object',
        }) {}
        export class Topology extends Create<_Topology>({
            name: 'Topology',
            typeClass: 'Object',
        }) {}
        export class Model extends Create<_Model>({
            name: 'Model',
            typeClass: 'Object',
        }) {}
        export class Trajectory extends Create<_Trajectory>({
            name: 'Trajectory',
            typeClass: 'Object',
        }) {}
        export class Structure extends Create<_Structure>({
            name: 'Structure',
            typeClass: 'Object',
        }) {}

        export namespace Structure {
            export class Representation3D extends CreateRepresentation3D<
            ...
            export class Representation3DState extends Create<Representation3DStateData>(
                { name: 'Structure 3D State', typeClass: 'Object' },
            ) {}
    ...
    export namespace Volume {
        ...
        export class Data extends Create<_Volume>({
            name: 'Volume',
            typeClass: 'Object',
        }) {}
        export class Lazy extends Create<LazyInfo>({
            name: 'Lazy Volume',
            typeClass: 'Object',
        }) {}
        export class Representation3D extends CreateRepresentation3D<
