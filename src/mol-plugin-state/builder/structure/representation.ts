...
import { createStructureRepresentationParams, type StructureRepresentationBuiltInProps, type StructureRepresentationProps } from '../../helpers/structure-representation-params.ts';
