...
import { getUnitcellData, UnitcellParams, UnitcellRepresentation } from '../../mol-repr/shape/model/unitcell.ts';
...
import { OrientationParams, OrientationRepresentation } from '../../mol-repr/shape/loci/orientation.ts';
...
const StructureRepresentation3D: StateTransformer<SO.Molecule.Structure, SO.Molecule.Structure.Representation3D> =
            ...
            if (!a) {
                ...
                return {
                    ...
                    colorTheme: PD.Mapped<any>(
                        ...
                        (name) =>
                            PD.Group<any>(
                                themeCtx.colorThemeRegistry.get(name).getParams({ structure: Structure.Empty }),
                            ),
                        colorThemeInfo,
                    ),
                    sizeTheme: PD.Mapped<any>(
                        ...
                        (name) =>
                            PD.Group<any>(
                                themeCtx.sizeThemeRegistry.get(name).getParams({ structure: Structure.Empty }),
                            ),
                    ),
                };
            }
        ...
        update({ a, b, oldParams, newParams, cache }, plugin: PluginContext) {
            return Task.create('Structure Representation', async (ctx) => {
                ...
                b.data.repr.setTheme(
                    Theme.create(plugin.representation.structure.themes, { structure: data }, newParams),
                );
...
const UnwindStructureAssemblyRepresentation3D: StateTransformer<
    SO.Molecule.Structure.Representation3D,
    SO.Molecule.Structure.Representation3DState
> = PluginStateTransform.BuiltIn({
...
const ExplodeStructureRepresentation3D: StateTransformer<
    SO.Molecule.Structure.Representation3D,
    SO.Molecule.Structure.Representation3DState
> = PluginStateTransform.BuiltIn({
...
const SpinStructureRepresentation3D: StateTransformer<
    SO.Molecule.Structure.Representation3D,
    SO.Molecule.Structure.Representation3DState
> = PluginStateTransform.BuiltIn({
...
const OverpaintStructureRepresentation3DFromScript: StateTransformer<
    SO.Molecule.Structure.Representation3D,
    SO.Molecule.Structure.Representation3DState
> = PluginStateTransform.BuiltIn({
...
const OverpaintStructureRepresentation3DFromBundle: StateTransformer<
    SO.Molecule.Structure.Representation3D,
    SO.Molecule.Structure.Representation3DState
> = PluginStateTransform.BuiltIn({
...
const TransparencyStructureRepresentation3DFromScript: StateTransformer<
    SO.Molecule.Structure.Representation3D,
    SO.Molecule.Structure.Representation3DState
> = PluginStateTransform.BuiltIn({
...
const TransparencyStructureRepresentation3DFromBundle: StateTransformer<
    SO.Molecule.Structure.Representation3D,
    SO.Molecule.Structure.Representation3DState
> = PluginStateTransform.BuiltIn({
...
const EmissiveStructureRepresentation3DFromScript: StateTransformer<
    SO.Molecule.Structure.Representation3D,
    SO.Molecule.Structure.Representation3DState
> = PluginStateTransform.BuiltIn({
...
const EmissiveStructureRepresentation3DFromBundle: StateTransformer<
    SO.Molecule.Structure.Representation3D,
    SO.Molecule.Structure.Representation3DState
> = PluginStateTransform.BuiltIn({
...
const SubstanceStructureRepresentation3DFromScript: StateTransformer<
    SO.Molecule.Structure.Representation3D,
    SO.Molecule.Structure.Representation3DState
> = PluginStateTransform.BuiltIn({
...
const SubstanceStructureRepresentation3DFromBundle: StateTransformer<
    SO.Molecule.Structure.Representation3D,
    SO.Molecule.Structure.Representation3DState
> = PluginStateTransform.BuiltIn({
...
const ClippingStructureRepresentation3DFromScript: StateTransformer<
    SO.Molecule.Structure.Representation3D,
    SO.Molecule.Structure.Representation3DState
> = PluginStateTransform.BuiltIn({
...
const ClippingStructureRepresentation3DFromBundle: StateTransformer<
    SO.Molecule.Structure.Representation3D,
    SO.Molecule.Structure.Representation3DState
> = PluginStateTransform.BuiltIn({
...
const ThemeStrengthRepresentation3D: StateTransformer<
    SO.Molecule.Structure.Representation3D,
    SO.Molecule.Structure.Representation3DState
> = PluginStateTransform.BuiltIn({
    ...
    apply({ a, params }) {
        return new SO.Molecule.Structure.Representation3DState({
            ...
            description: `${params.overpaintStrength.toFixed(2)}, ${params.transparencyStrength.toFixed(2)}, ${
                params.emissiveStrength.toFixed(2)
            }, ${params.substanceStrength.toFixed(2)}`,
        });
    },
    update({ a, b, newParams, oldParams }) {
        if (
        ...
        b.description = `${newParams.overpaintStrength.toFixed(2)}, ${newParams.transparencyStrength.toFixed(2)}, ${
            newParams.emissiveStrength.toFixed(2)
        }, ${newParams.substanceStrength.toFixed(2)}`;
        return StateTransformer.UpdateResult.Updated;
    },
    interpolate(src, tar, t) {
        return {
...
const VolumeRepresentation3D: StateTransformer<SO.Volume.Data, SO.Volume.Representation3D> = PluginStateTransform
    .BuiltIn({
...
const ShapeRepresentation3D: StateTransformer<SO.Shape.Provider, SO.Shape.Representation3D> = PluginStateTransform
    .BuiltIn({
...
const StructureBoundingBox3D: StateTransformer<SO.Molecule.Structure, SO.Shape.Representation3D> = PluginStateTransform
    .BuiltIn({
...
const StructureSelectionsDistance3D: StateTransformer<SO.Molecule.Structure.Selections, SO.Shape.Representation3D> =
    PluginStateTransform.BuiltIn({
...
const StructureSelectionsAngle3D: StateTransformer<SO.Molecule.Structure.Selections, SO.Shape.Representation3D> =
    PluginStateTransform.BuiltIn({
...
const StructureSelectionsDihedral3D: StateTransformer<SO.Molecule.Structure.Selections, SO.Shape.Representation3D> =
    PluginStateTransform.BuiltIn({
...
const StructureSelectionsLabel3D: StateTransformer<SO.Molecule.Structure.Selections, SO.Shape.Representation3D> =
    PluginStateTransform.BuiltIn({
...
const StructureSelectionsOrientation3D: StateTransformer<SO.Molecule.Structure.Selections, SO.Shape.Representation3D> =
    PluginStateTransform.BuiltIn({
...
const StructureSelectionsPlane3D: StateTransformer<SO.Molecule.Structure.Selections, SO.Shape.Representation3D> =
    PluginStateTransform.BuiltIn({
