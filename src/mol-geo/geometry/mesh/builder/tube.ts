...
export function addTube(
            ...
            if (doubleRoundCap) {
                capSmoothingFactor = Math.max(
                    ...
                    Math.sqrt(
                        1 -
                            Math.pow(
                                (sc ? halfLinearSegments! - i : i - halfLinearSegments!) /
                                    halfLinearSegments!,
                                2,
                            ),
                    ),
    ...
    const addedVertexCount = (linearSegments + 1) * radialSegments +
        (startCap ? radialSegments + 1 : 0) + (endCap ? radialSegments + 1 : 0);
