...
import type { DirectVolumeValues } from '../../../mol-gl/renderable/direct-volume.ts';
...
export namespace DirectVolume {
    ...
    function update(
        ...
        ValueCell.update(
            ...
            Vec4.set(directVolume.gridStats.ref.value, stats.min, stats.max, stats.mean, stats.sigma),
        );
