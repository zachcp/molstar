...
export const AlkaliMetals = new Set<ElementSymbol>(
    ['LI', 'NA', 'K', 'RB', 'CS', 'FR'] as ElementSymbol[],
);
export function isAlkaliMetal(element: ElementSymbol) {
    return AlkaliMetals.has(element);
}

export const AlkalineEarthMetals = new Set<ElementSymbol>(
    ['BE', 'MG', 'CA', 'SR', 'BA', 'RA'] as ElementSymbol[],
);
export function isAlkalineEarthMetal(element: ElementSymbol) {
    return AlkalineEarthMetals.has(element);
}

export const PolyatomicNonmetals = new Set<ElementSymbol>(['C', 'P', 'S', 'SE'] as ElementSymbol[]);
export function isPolyatomicNonmetal(element: ElementSymbol) {
    return PolyatomicNonmetals.has(element);
}

export const DiatomicNonmetals = new Set<ElementSymbol>(
    ['H', 'N', 'O', 'F', 'CL', 'BR', 'I'] as ElementSymbol[],
);
export function isDiatomicNonmetal(element: ElementSymbol) {
    return DiatomicNonmetals.has(element);
}

export const NobleGases = new Set<ElementSymbol>(
    ['HE', 'NE', 'AR', 'KR', 'XE', 'RN'] as ElementSymbol[],
);
export function isNobleGas(element: ElementSymbol) {
    return NobleGases.has(element);
}

export const PostTransitionMetals = new Set<ElementSymbol>(
    ['ZN', 'GA', 'CD', 'IN', 'SN', 'HG', 'TI', 'PB', 'BI', 'PO', 'CN'] as ElementSymbol[],
);
export function isPostTransitionMetal(element: ElementSymbol) {
    return PostTransitionMetals.has(element);
}

export const Metalloids = new Set<ElementSymbol>(
    ['B', 'SI', 'GE', 'AS', 'SB', 'TE', 'AT'] as ElementSymbol[],
);
export function isMetalloid(element: ElementSymbol) {
    return Metalloids.has(element);
}

export const Halogens = new Set<ElementSymbol>(['F', 'CL', 'BR', 'I', 'AT'] as ElementSymbol[]);
export function isHalogen(element: ElementSymbol) {
