...
export function CoarseElementReference(): CoarseElementReference {
    return { kind: undefined, index: -1 as ElementIndex };
}
...
export function CoarseElementKey(): CoarseElementKey {
    return { label_entity_id: '', label_asym_id: '', label_seq_id: -1 };
}
