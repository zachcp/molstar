...
import { AtomicHierarchy, AtomicConformation, AtomicRanges, VdwRadius } from './properties/atomic.ts';
...
import { Coordinates, Frame } from '../coordinates.ts';
...
import { ChainIndex, ElementIndex } from './indexing.ts';
