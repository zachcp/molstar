...
namespace Predicates {
    export interface SetLike<A> {
        has(v: A): boolean;
    }
    function isSetLike<A>(x: any): x is SetLike<A> {
        return !!x && !!x.has;
    }

    export function eq<A>(p: QueryFn<A>, value: A): QueryPredicate {
        return (l) => p(l) === value;
    }
    export function lt<A>(p: QueryFn<A>, value: A): QueryPredicate {
        return (l) => p(l) < value;
    }
    export function lte<A>(p: QueryFn<A>, value: A): QueryPredicate {
        return (l) => p(l) <= value;
    }
    export function gt<A>(p: QueryFn<A>, value: A): QueryPredicate {
        return (l) => p(l) > value;
    }
    export function gte<A>(p: QueryFn<A>, value: A): QueryPredicate {
        return (l) => p(l) >= value;
    }
    ...
    function _false(ctx: QueryContextView) {
        return false;
    }
