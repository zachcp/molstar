...
import { Interval, IntMap, type Iterator, Segmentation, SortedArray } from '../../../mol-data/int.ts';
import { UniqueArray } from '../../../mol-data/generic.ts';
import { SymmetryOperator } from '../../../mol-math/geometry/symmetry-operator.ts';
import { type ElementIndex, Model } from '../model.ts';
import { arraySwap, hash1, hashFnv32a, hashString, sort, sortArray } from '../../../mol-data/util.ts';
...
import type { ChainIndex, EntityIndex, ResidueIndex } from '../model/indexing.ts';
...
import { getIntraUnitBondMapping, getSerialMapping, type IntraUnitBondMapping, type SerialMapping } from './mapping.ts';
...
class Structure {
    ...
    asParent(): Structure {
        ...
        if (this.parent) {
            const p = this.parent.coordinateSystem.isIdentity ? this.parent : Structure.transform(
                this.parent,
