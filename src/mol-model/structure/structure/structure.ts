...
import { IntMap, SortedArray, type Iterator, Segmentation, Interval } from '../../../mol-data/int.ts';
...
import type { ResidueIndex, ChainIndex, EntityIndex } from '../model/indexing.ts';
...
import { type IntraUnitBondMapping, getIntraUnitBondMapping, getSerialMapping, type SerialMapping } from './mapping.ts';
