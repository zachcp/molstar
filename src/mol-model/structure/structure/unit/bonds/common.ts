...
const __ElementIndex: { [e: string]: number | undefined } = {
    'H': 0,
    'h': 0,
    'D': 0,
    'd': 0,
...
const __ElementBondThresholds: { [e: number]: number | undefined } = {
    0: 1.42,
    1: 1.42,
    3: 2.7,
    4: 2.7,
 ...
 */
const __ElementPairThresholds: { [e: number]: number | undefined } = {
    0: 0.8,
    20: 1.31,
    27: 1.2,
    35: 1.15,
...
export function getPairingThreshold(
    elementIndexA: number,
    elementIndexB: number,
    thresholdA: number,
    thresholdB: number,
) {
    const thresholdAB = getElementPairThreshold(elementIndexA, elementIndexB);
    return thresholdAB > 0 ? thresholdAB : elementIndexB < 0 ? thresholdA : (thresholdA + thresholdB) / 1.95; // not sure if avg or min but max is too big
}
