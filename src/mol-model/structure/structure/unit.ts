...
import { computeIntraUnitBonds, IntraUnitBonds } from './unit/bonds.ts';
import {
    CoarseElements,
...
import { ChainIndex, ElementIndex, ResidueIndex } from '../model/indexing.ts';
...
namespace Unit {
    ...
    export interface Base {
         ...
         */
        readonly objectPrimitive:
            mmCIF_Schema['ihm_model_representation_details']['model_object_primitive']['T'];
    }
    ...
    > implements Base {
        ...
        constructor(
            ...
            this.coarseConformation =
                (kind === Kind.Spheres
                    ? model.coarseConformation.spheres
                    : model.coarseConformation.gaussians) as C;
            this.props = props;
        }
    }
    ...
    export function areSameChainOperatorGroup(a: Unit, b: Unit) {
        return a.chainGroupId === b.chainGroupId &&
