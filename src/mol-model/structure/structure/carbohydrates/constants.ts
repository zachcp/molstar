...
const Monosaccharides: SaccharideComponent[] = [
...

    {
        ...
        color: SaccharideColors.Blue,
        type: SaccharideType.HexNAc,
    },
    {
        abbr: 'ManNAc',
        name: 'N-Acetyl Mannosamine',
        color: SaccharideColors.Green,
        type: SaccharideType.HexNAc,
    },
    {
        abbr: 'GalNAc',
        name: 'N-Acetyl Galactosamine',
        color: SaccharideColors.Yellow,
        type: SaccharideType.HexNAc,
    },
    {
        abbr: 'GulNAc',
        name: 'N-Acetyl Gulosamine',
        color: SaccharideColors.Orange,
        type: SaccharideType.HexNAc,
    },
    {
        abbr: 'AltNAc',
        name: 'N-Acetyl Altrosamine',
        color: SaccharideColors.Pink,
        type: SaccharideType.HexNAc,
    },
    {
        abbr: 'AllNAc',
        name: 'N-Acetyl Allosamine',
        color: SaccharideColors.Purple,
        type: SaccharideType.HexNAc,
    },
    {
        abbr: 'TalNAc',
        name: 'N-Acetyl Talosamine',
        color: SaccharideColors.LightBlue,
        type: SaccharideType.HexNAc,
    },
    {
        abbr: 'IdoNAc',
        name: 'N-Acetyl Idosamine',
        color: SaccharideColors.Brown,
        type: SaccharideType.HexNAc,
    },

    {
        ...
        name: 'Glucosamine',
        color: SaccharideColors.Blue,
        type: SaccharideType.Hexosamine,
    },
    {
        abbr: 'ManN',
        name: 'Mannosamine',
...

    {
        ...
        name: 'Quinovose',
        color: SaccharideColors.Blue,
        type: SaccharideType.Deoxyhexose,
    },
    {
        abbr: 'Rha',
        name: 'Rhamnose',
...

    {
        ...
        color: SaccharideColors.Blue,
        type: SaccharideType.DeoxyhexNAc,
    },
    {
        abbr: 'RhaNAc',
    ...
    {
        abbr: '6dAltNAc',
        name: 'N-Acetyl 6-Deoxy Altrosamine',
        color: SaccharideColors.Pink,
        type: SaccharideType.DeoxyhexNAc,
    },
    {
        abbr: '6dTalNAc',
        name: 'N-Acetyl 6-Deoxy Talosamine',
        color: SaccharideColors.LightBlue,
        type: SaccharideType.DeoxyhexNAc,
    },
    {
...

    {
        ...
        name: 'Olivose',
        color: SaccharideColors.Blue,
        type: SaccharideType.DiDeoxyhexose,
    },
    {
        abbr: 'Tyv',
        name: 'Tyvelose',
    ...
    {
        abbr: 'Kdn',
        name: 'Keto-Deoxy Nonulonic Acid',
        color: SaccharideColors.Green,
        type: SaccharideType.Deoxynonulosonate,
    },
    {
        abbr: 'Neu5Ac',
...

    {
        ...
        color: SaccharideColors.Green,
        type: SaccharideType.DiDeoxynonulosonate,
    },
    {
        abbr: 'Leg',
        name: 'Legionaminic Acid',
        color: SaccharideColors.Yellow,
        type: SaccharideType.DiDeoxynonulosonate,
    },
    {
        abbr: 'Aci',
        name: 'Acinetaminic Acid',
        color: SaccharideColors.Pink,
        type: SaccharideType.DiDeoxynonulosonate,
    },
    {
        abbr: '4eLeg',
        name: '4-Epilegionaminic Acid',
        color: SaccharideColors.LightBlue,
        type: SaccharideType.DiDeoxynonulosonate,
    },
    ...
    {
        abbr: 'Kdo',
        name: 'Keto-Deoxy Octulonic Acid',
        color: SaccharideColors.Yellow,
        type: SaccharideType.Unknown,
    },
    {
    ...
    {
        abbr: 'MurNAc',
        name: 'N-Acetyl Muramic Acid',
        color: SaccharideColors.Purple,
        type: SaccharideType.Unknown,
    },
    {
        abbr: 'MurNGc',
        name: 'N-Glycolyl Muramic Acid',
        color: SaccharideColors.LightBlue,
        type: SaccharideType.Unknown,
    },
    {
...
export function setSaccharideCompIdMapType(type: SaccharideCompIdMapType) {
    SaccharideCompIdMap = type === 'default'
        ? DefaultSaccharideCompIdMap
        : GlycamSaccharideCompIdMap;
}
