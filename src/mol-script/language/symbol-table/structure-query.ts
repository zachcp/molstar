...
export namespace Types {
    ...
    export const BondFlag: Type.OneOf<string> = Type.OneOf('Structure', 'BondFlag', Type.Str, [
        'covalent',
        'metallic',
        'ion',
        'hydrogen',
    ...
    export const SecondaryStructureFlag: Type.OneOf<string> = Type.OneOf(
        'Structure',
        'SecondaryStructureFlag',
        Type.Str,
        ['alpha', 'beta', '3-10', 'pi', 'sheet', 'strand', 'helix', 'turn', 'none'],
    );
    export const SecondaryStructureFlags: Type.Container<number> = Core.Types.Flags(
        SecondaryStructureFlag,
        'SecondaryStructureFlag',
    );

    export const RingFingerprint: Type.Value<unknown> = Type.Value('Structure', 'RingFingerprint');
    export const EntityType: Type.OneOf<string> = Type.OneOf('Structure', 'EntityType', Type.Str, [
        'polymer',
        'non-polymer',
        'water',
        'branched',
    ]);
    export const EntitySubtype: Type.OneOf<string> = Type.OneOf('Structure', 'EntitySubtype', Type.Str, [
        'other',
        'polypeptide(D)',
        'polypeptide(L)',
    ...
    export const ObjectPrimitive: Type.OneOf<string> = Type.OneOf('Structure', 'ObjectPrimitive', Type.Str, [
        'atomistic',
        'sphere',
        'gaussian',
        'other',
    ...
    export const ElementSelectionQuery: Type.Container<(env: any) => unknown> = Core.Types.Fn(
        ElementSelection,
