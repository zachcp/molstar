...
export namespace Types {
    ...
    export const SecondaryStructureFlag = Type.OneOf(
        'Structure',
        'SecondaryStructureFlag',
        Type.Str,
        ['alpha', 'beta', '3-10', 'pi', 'sheet', 'strand', 'helix', 'turn', 'none'],
    );
    export const SecondaryStructureFlags = Core.Types.Flags(
        SecondaryStructureFlag,
        'SecondaryStructureFlag',
    );
...
const type = {
    ...
    entityType: symbol(
        ...
        Types.EntityType,
        `Create normalized representation of entity type: ${
            Type.oneOfValues(Types.EntityType).join(', ')
        }.`,
    ),
    ...
    atomGroups: symbol(
        Arguments.Dictionary({
            ...
            'group-by': Argument(Type.Any, {
                ...
                description:
                    'Group atoms to sets based on this property. Default: each atom has its own set',
            }),
        }),
    ...
    bondedAtomicPairs: symbol(
        Arguments.Dictionary({
            0: Argument(Type.Bool, {
                ...
                description:
                    'Test each bond with this predicate. Each bond is visited twice with swapped atom order.',
            }),
    ...
    within: symbol(
        Arguments.Dictionary({
            ...
            invert: Argument(Type.Bool, {
                ...
                defaultValue: false,
                description:
                    'If true, pick only atom sets that are further than the specified radius.',
            }),
        }),
        Types.ElementSelectionQuery,
    ...
    isConnectedTo: symbol(
        Arguments.Dictionary({
            ...
            disjunct: Argument(Type.Bool, {
                ...
                defaultValue: true,
                description:
                    'If true, there must exist a bond to an atom that lies outside the given atom set to pass test.',
            }),
            invert: Argument(Type.Bool, {
                isOptional: true,
                defaultValue: false,
...
const atomProperty = {
    ...
    core: {
        ...
        instanceId: atomProp(
            Type.Str,
            'Canonical name of the symmetry operator applied to this element.',
        ),
    ...
    topology: {
        connectedComponentKey: atomProp(
            Type.AnyValue,
    ...
    macromolecular: {
        ...
        secondaryStructureKey: atomProp(
            Type.AnyValue,
        ...
        isModified: atomProp(
            Type.Bool,
            'True if the atom belongs to modification of a standard residue.',
        ),
