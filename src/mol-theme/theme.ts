...
export class ThemeRegistry<T extends ColorTheme<any, any> | SizeTheme<any>> {
    ...
    get default(): { name: string; provider: ThemeProvider<T, any> } {
        return this._list[0];
    }
    get list(): { name: string; provider: ThemeProvider<T, any> }[] {
        return this._list;
    }
