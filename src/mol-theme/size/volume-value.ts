...
const Description =
  "Assign size based on the given value of a volume cell. Negative values are made positive.";

export const VolumeValueSizeThemeParams: PD.Params = {
...
> = {
  ...
  isApplicable: (ctx: ThemeDataContext) =>
    !!ctx.volume && !Volume.Segmentation.get(ctx.volume),
};
