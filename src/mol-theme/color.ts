...
import { type ThemeDataContext, type ThemeProvider, ThemeRegistry } from './theme.ts';
...
namespace ColorTheme {
    ...
    export type ParamValues<C extends ColorTheme.Provider<any>> = C extends ColorTheme.Provider<infer P> ? PD.Values<P>
        : never;
