...
export function moleculeTypeColor(
    colorMap: MoleculeTypeColors,
    unit: Unit,
...
export const MoleculeTypeColorThemeProvider: ColorTheme.Provider<
    MoleculeTypeColorThemeParams,
    'molecule-type'
> = {
    name: 'molecule-type',
    label: 'Molecule Type',
