...
import { OperatorNameColorTheme, OperatorNameColorThemeParams } from './operator-name.ts';
...
export function ElementSymbolColorTheme(
    ...
    const granularity =
        (props.carbonColor.name === 'operator-name' || props.carbonColor.name === 'unit-index')
            ? 'groupInstance'
            : 'group';
...
export const ElementSymbolColorThemeProvider: ColorTheme.Provider<
