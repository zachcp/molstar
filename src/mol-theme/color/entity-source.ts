...
import { StructureProperties, StructureElement, Bond, Model } from '../../mol-model/structure.ts';
...
import { Column } from '../../mol-data/db/column.ts';
import { Table } from '../../mol-data/db/table.ts';
