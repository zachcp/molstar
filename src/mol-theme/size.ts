...
import { LocationSize, SizeType } from '../mol-geo/geometry/size-data.ts';
...
namespace SizeTheme {
    ...
    export type ParamValues<C extends SizeTheme.Provider<any>> = C extends
        SizeTheme.Provider<infer P> ? PD.Values<P> : never;
