...
import { type QueryPredicate, type StructureElement, StructureProperties as Props } from '../../../mol-model/structure.ts';
import type { AtomsQueryParams } from '../../../mol-model/structure/query/queries/generators.ts';
import type { AtomSiteSchema, AtomSiteSchemaElement } from '../server/api.ts';
