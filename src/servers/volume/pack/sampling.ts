...
import { createTypedArray, getElementByteSize, type TypedArrayValueType } from '../../../mol-io/common/typed-array.ts';
...
export async function createContext(
    ...
    const cubeBuffer = Buffer.from(
        new ArrayBuffer(channels.length * blockSize * blockSize * blockSize * getElementByteSize(valueType)),
    );
