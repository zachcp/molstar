...
export class ViewportControls extends PluginUIComponent<ViewportControlsProps, ViewportControlsState> {
    ...
    override state: ViewportControlsState = { ...this.allCollapsedState, isCameraResetEnabled: true };
    ...
    override render() {
        ...
        const xrTitle = !xrIsSupported
            ? 'Augmented/Virtual Reality unavailable'
            : (xrIsPresenting ? 'Exit XR' : 'Enter XR');
                            ...
                            <div className='msp-hover-box-wrapper'>
                                ...
                                <div className='msp-hover-box-body'>
                                    <div className='msp-flex-column'>
                                        ...
                                        <div className='msp-flex-row'>
                                            <Button
                                                onClick={() => PluginCommands.Camera.OrientAxes(this.plugin)}
                                                disabled={!this.state.isCameraResetEnabled}
