...
import { AnimationControls } from './state/animation.ts';
import { StructureComponentControls } from './structure/components.ts';
import { StructureMeasurementsControls } from './structure/measurements.ts';
import { StructureSelectionActionsControls } from './structure/selection.ts';
import { StructureSourceControls } from './structure/source.ts';
import { VolumeStreamingControls, VolumeSourceControls } from './structure/volume.ts';
import { PluginConfig } from '../mol-plugin/config.ts';
import { StructureSuperpositionControls } from './structure/superposition.ts';
import { StructureQuickStylesControls } from './structure/quick-styles.ts';
import { Markdown } from './controls/markdown.ts';
