...
export class DownloadScreenshotControls extends PluginUIComponent<{ close: () => void }, ImageControlsState> {
    override state: ImageControlsState = { showPreview: true, isDisabled: false } as ImageControlsState;
        ...
        return (
            <div>
                ...
                <div className='msp-flex-row'>
                    ...
                    {this.state.imageData && (
                        <Button onClick={() => this.setState({ imageData: void 0 })} disabled={this.state.isDisabled}>
                            Clear
                        </Button>
                    )}
