...
export function Icon(props: {
    ...
    return (
        <span
            className={`msp-icon msp-material-icon${props.inline ? ' msp-icon-inline' : ''}`}
            title={props.title}
            style={props.style}
        >
            <props.svg />
...
const _Union = (
    <svg width='24px' height='24px' viewBox='0 0 24 24'>
        <defs>{circleLeft}{circleRight}</defs>
        <g>
    ...
    <svg width='24px' height='24px' viewBox='0 0 24 24'>
        <defs>
            ...
            <mask id='mask-left'>
                ...
                <use href='#circle-right' fill='black' strokeWidth='0px' stroke='white' />
            </mask>
        </defs>
        <g>
...
const _CubeOutline = (
    <svg width='24px' height='24px' viewBox='0 0 24 24' strokeWidth='0.1px'>
        <path d='M21,16.5C21,16.88 20.79,17.21 20.47,17.38L12.57,21.82C12.41,21.94 12.21,22 12,22C11.79,22 11.59,21.94 11.43,21.82L3.53,17.38C3.21,17.21 3,16.88 3,16.5V7.5C3,7.12 3.21,6.79 3.53,6.62L11.43,2.18C11.59,2.06 11.79,2 12,2C12.21,2 12.41,2.06 12.57,2.18L20.47,6.62C20.79,6.79 21,7.12 21,7.5V16.5M12,4.15L6.04,7.5L12,10.85L17.96,7.5L12,4.15M5,15.91L11,19.29V12.58L5,9.21V15.91M19,15.91V9.21L13,12.58V19.29L19,15.91Z' />
    </svg>
);
export function CubeOutlineSvg() {
    return _CubeOutline;
}
...
export function CubeSendSvg() {
    return _CubeSend;
}

const _CursorDefaultOutline = (
    <svg width='24px' height='24px' viewBox='0 0 24 24'>
...
export function LightbulbOnOutlineSvg() {
...
export function PencilRulerSvg() {
    return _PencilRuler;
}
...
export function AspectRatioSvg() {
    return _AspectRatio;
}
const _BlurOn = (
    <svg width='24px' height='24px' viewBox='0 0 24 24'>
...
export function CropOrginalSvg() {
    return _CropOriginal;
}
const _DeleteOutlined = (
    <svg width='24px' height='24px' viewBox='0 0 24 24'>
...
export function TooltipTextSvg() {
    return _TooltipText;
}
const _TooltipTextOutline = (
    <svg width='24px' height='24px' viewBox='0 0 24 24'>
...
export function TooltipTextOutlineSvg() {
    return _TooltipTextOutline;
}
const _PlusBox = (
    <svg width='24px' height='24px' viewBox='0 0 24 24'>
        <path d='M19 3H5c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2m-2 10h-4v4h-2v-4H7v-2h4V7h2v4h4z' />
    </svg>
);
export function PlusBoxSvg() {
    return _PlusBox;
}
const _MinusBox = (
    <svg width='24px' height='24px' viewBox='0 0 24 24'>
