        ...
        return (
            <>
                ...
                <NoncollapsableGroup title='Apply Style'>
                    <div className='msp-flex-row'>
                        <Button
                            title='Applies default appearance (no outline, no ignore-light)'
                            onClick={() => this.applyStyle('default')}
                            disabled={this.state.busy}
                        >
                            Default
                        </Button>
                        <Button
                            title='Applies illustrative appearance (outline, ignore-light)'
                            onClick={() => this.applyStyle('illustrative')}
                            disabled={this.state.busy}
                        >
                            Illustrative
                        </Button>
...
async function applyRepresentationPreset(
    ...
    switch (preset) {
        case 'default':
            const defaultPreset = plugin.config.get(PluginConfig.Structure.DefaultRepresentationPreset) ||
