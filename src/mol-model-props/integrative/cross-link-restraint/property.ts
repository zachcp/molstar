...
import { PairRestraint, PairRestraints } from '../pair-restraints.ts';
...
export const CrossLinkRestraintProvider: CustomStructureProperty.Provider<
    {},
    CrossLinkRestraintValue
> = CustomStructureProperty.createProvider({
    ...
    isApplicable: (data: Structure) =>
        data.models.some((m) => !!ModelCrossLinkRestraint.Provider.get(m)),
