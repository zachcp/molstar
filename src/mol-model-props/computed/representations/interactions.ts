...
const InteractionsVisuals = {
    'intra-unit': (
        ...
        'Intra-unit interactions cylinder',
        ctx,
        getParams,
        InteractionsIntraUnitVisual,
    ),
    'inter-unit': (
        ...
        'Inter-unit interactions cylinder',
        ctx,
        getParams,
        InteractionsInterUnitVisual,
    ),
...
export const InteractionsRepresentationProvider = StructureRepresentationProvider({
    ...
    isApplicable: (structure: Structure) =>
        structure.elementCount > 0 && InteractionsProvider.isApplicable(structure),
    ...
    mustRecreate: (
        oldProps: PD.Values<InteractionsParams>,
        newProps: PD.Values<InteractionsParams>,
    ) => {
