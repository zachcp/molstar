...
import type { ValueBox } from '../../mol-util/index.ts';
import { OrderedMap } from 'immutable';
import type { Asset, AssetManager } from '../../mol-util/assets.ts';
...
namespace CustomProperty {
    ...
    export class Registry<Data> {
        private providers = OrderedMap<
            string,
            Provider<Data, any, any>
        >().asMutable();
        ...
        register(provider: Provider<Data, any, any>, defaultAutoAttach: boolean) {
            ...
            this.defaultAutoAttachValues.set(
