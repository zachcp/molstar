...
import { Theme, type ThemeRegistryContext } from '../mol-theme/theme.ts';
...
import { getQualityProps, type LocationCallback } from './util.ts';
...
export class RepresentationRegistry<D, S extends Representation.State> {
    ...
    get default(): { name: string; provider: RepresentationProvider<D, any, any> } {
        return this._list[0];
    }
