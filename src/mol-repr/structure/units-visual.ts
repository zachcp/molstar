...
import type { RepresentationProps } from '../representation.ts';
...
import { createUnitsTransform, includesUnitKind, type StructureGroup } from './visual/util/common.ts';
...
export function UnitsVisual<G extends Geometry, P extends StructureParams & Geometry.Params<G>>(
    ...
    function prepareUpdate(theme: Theme, props: PD.Values<P>, structureGroup: StructureGroup) {
        ...
        if (
            ...
            newProps.cellSize !== currentProps.cellSize || newProps.batchSize !== currentProps.batchSize
        ) {
            updateState.updateTransform = true;
        }
        ...
        if (updateState.createNew) {
            ...
            if (updateState.updateMatrix) {
                ...
                createUnitsTransform(
                    ...
                    newGeometry?.boundingSphere || renderObject.values.invariantBoundingSphere.ref.value,
                    newProps.cellSize,
                    newProps.batchSize,
                    renderObject.values,
                );
