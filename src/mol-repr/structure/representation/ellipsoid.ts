...
import { type RepresentationParamsGetter, type RepresentationContext, Representation } from '../../../mol-repr/representation.ts';
...
import { EllipsoidMeshParams, EllipsoidMeshVisual, type StructureEllipsoidMeshParams, StructureEllipsoidMeshVisual } from '../visual/ellipsoid-mesh.ts';
import { AtomSiteAnisotrop } from '../../../mol-model-formats/structure/property/anisotropic.ts';
import { IntraUnitBondCylinderParams, IntraUnitBondCylinderVisual, type StructureIntraUnitBondCylinderParams, StructureIntraUnitBondCylinderVisual } from '../visual/bond-intra-unit-cylinder.ts';
