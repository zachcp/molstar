...
import {
    ...
    IntraUnitBondLineVisual,
    type StructureIntraUnitBondLineParams,
    StructureIntraUnitBondLineVisual,
} from '../visual/bond-intra-unit-line.ts';
import { InterUnitBondLineParams, InterUnitBondLineVisual } from '../visual/bond-inter-unit-line.ts';
...
import {
    ElementCrossParams,
    ElementCrossVisual,
    type StructureElementCrossParams,
    StructureElementCrossVisual,
} from '../visual/element-cross.ts';
...
const LineVisuals = {
    'intra-bond': (
        ...
        getParams: RepresentationParamsGetter<Structure, IntraUnitBondLineParams>,
    ): StructureRepresentation<IntraUnitBondLineParams> =>
        UnitsRepresentation(
            'Intra-unit bond line',
            ctx,
            getParams,
            IntraUnitBondLineVisual,
        ),
    'inter-bond': (
        ctx: RepresentationContext,
        getParams: RepresentationParamsGetter<Structure, InterUnitBondLineParams>,
    ): StructureRepresentation<InterUnitBondLineParams> =>
        ComplexRepresentation(
            'Inter-unit bond line',
            ctx,
            getParams,
    ...
    ): StructureRepresentation<ElementPointParams> => UnitsRepresentation('Points', ctx, getParams, ElementPointVisual),
    'element-cross': (
        ctx: RepresentationContext,
        getParams: RepresentationParamsGetter<Structure, ElementCrossParams>,
    ): StructureRepresentation<ElementCrossParams> =>
        UnitsRepresentation('Crosses', ctx, getParams, ElementCrossVisual),
    'structure-intra-bond': (
        ctx: RepresentationContext,
        getParams: RepresentationParamsGetter<
            Structure,
            StructureIntraUnitBondLineParams
        >,
    ): StructureRepresentation<StructureIntraUnitBondLineParams> =>
        ComplexRepresentation(
            'Structure intra-unit bond line',
            ctx,
            getParams,
            StructureIntraUnitBondLineVisual,
        ),
    ...
    'structure-element-cross': (
        ctx: RepresentationContext,
        getParams: RepresentationParamsGetter<
            Structure,
            StructureElementCrossParams
        >,
    ): StructureRepresentation<StructureElementCrossParams> =>
        ComplexRepresentation(
            'Structure element crosses',
            ctx,
            getParams,
            StructureElementCrossVisual,
        ),
...
export const LineParams = {
    ...
    visuals: PD.MultiSelect(
        ['intra-bond', 'inter-bond', 'element-point', 'element-cross'],
        PD.objectToOptions(LineVisuals),
    ),
    density: PD.Numeric(
        0.1,
...
export function LineRepresentation(
    ctx: RepresentationContext,
    getParams: RepresentationParamsGetter<Structure, LineParams>,
): LineRepresentation {
    return Representation.createMulti(
        ...
        getParams,
        StructureRepresentationStateBuilder,
        LineVisuals as unknown as Representation.Def<Structure, LineParams>,
    );
}
...
export const LineRepresentationProvider = StructureRepresentationProvider({
    ...
    mustRecreate: (
        oldProps: PD.Values<LineParams>,
        newProps: PD.Values<LineParams>,
    ) => {
