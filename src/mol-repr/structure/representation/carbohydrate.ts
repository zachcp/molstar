...
const CarbohydrateVisuals = {
  ...
  ): StructureRepresentation<CarbohydrateSymbolParams> =>
  ...
  ): StructureRepresentation<CarbohydrateLinkParams> =>
    ComplexRepresentation(
  ...
  "carbohydrate-terminal-link": (
    ...
    getParams: RepresentationParamsGetter<
      ...
      CarbohydrateTerminalLinkParams
    >,
  ): StructureRepresentation<CarbohydrateTerminalLinkParams> =>
    ComplexRepresentation(
...
export function getCarbohydrateParams(
  ...
  structure: Structure,
): typeof CarbohydrateParams {
  return CarbohydrateParams;
}

export type CarbohydrateRepresentation =
  StructureRepresentation<CarbohydrateParams>;
export function CarbohydrateRepresentation(
  ...
  return Representation.createMulti(
    ...
    getParams,
    StructureRepresentationStateBuilder,
    CarbohydrateVisuals as unknown as Representation.Def<
      Structure,
      CarbohydrateParams
    >,
  );
...
export const CarbohydrateRepresentationProvider =
  StructureRepresentationProvider({
    name: "carbohydrate",
    label: "Carbohydrate",
