...
const GaussianSurfaceVisuals = {
    ...
    ) => UnitsRepresentation('Gaussian surface mesh', ctx, getParams, GaussianSurfaceVisual),
    'structure-gaussian-surface-mesh': (
        ctx: RepresentationContext,
        getParams: RepresentationParamsGetter<Structure, StructureGaussianSurfaceMeshParams>,
    ) => ComplexRepresentation(
        'Structure-Gaussian surface mesh',
        ctx,
        getParams,
    ...
    ) => UnitsRepresentation('Gaussian surface wireframe', ctx, getParams, GaussianWireframeVisual),
};
...
export function GaussianSurfaceRepresentation(
    ...
    return Representation.createMulti(
        ...
        getParams,
        StructureRepresentationStateBuilder,
        GaussianSurfaceVisuals as unknown as Representation.Def<Structure, GaussianSurfaceParams>,
    );
}
