...
import {
  ...
  type StructureGaussianSurfaceMeshParams,
  StructureGaussianSurfaceVisual,
  GaussianSurfaceVisual,
} from "../visual/gaussian-surface-mesh.ts";
import { UnitsRepresentation } from "../units-representation.ts";
import {
  GaussianWireframeVisual,
  GaussianWireframeParams,
} from "../visual/gaussian-surface-wireframe.ts";
...
const GaussianSurfaceVisuals = {
  "gaussian-surface-mesh": (
    ...
    getParams: RepresentationParamsGetter<Structure, GaussianSurfaceMeshParams>,
  ): StructureRepresentation<GaussianSurfaceMeshParams> =>
    UnitsRepresentation(
      "Gaussian surface mesh",
      ctx,
      getParams,
  ...
  "structure-gaussian-surface-mesh": (
    ...
    getParams: RepresentationParamsGetter<
      Structure,
      StructureGaussianSurfaceMeshParams
    >,
  ): StructureRepresentation<StructureGaussianSurfaceMeshParams> =>
    ComplexRepresentation(
      "Structure-Gaussian surface mesh",
      ctx,
      getParams,
  ...
  "gaussian-surface-wireframe": (
    ctx: RepresentationContext,
    getParams: RepresentationParamsGetter<Structure, GaussianWireframeParams>,
  ): StructureRepresentation<GaussianWireframeParams> =>
    UnitsRepresentation(
      "Gaussian surface wireframe",
      ctx,
      getParams,
...
export const GaussianSurfaceParams = {
  ...
  visuals: PD.MultiSelect(
    ["gaussian-surface-mesh"],
    PD.objectToOptions(GaussianSurfaceVisuals),
  ),
...
export function getGaussianSurfaceParams(
  ...
  structure: Structure,
): typeof GaussianSurfaceParams {
  return GaussianSurfaceParams;
}

export type GaussianSurfaceRepresentation =
  StructureRepresentation<GaussianSurfaceParams>;
export function GaussianSurfaceRepresentation(
  ctx: RepresentationContext,
  getParams: RepresentationParamsGetter<Structure, GaussianSurfaceParams>,
): GaussianSurfaceRepresentation {
  return Representation.createMulti(
    "Gaussian Surface",
    ctx,
    getParams,
    StructureRepresentationStateBuilder,
    GaussianSurfaceVisuals as unknown as Representation.Def<
      Structure,
...
export const GaussianSurfaceRepresentationProvider =
  StructureRepresentationProvider({
