...
import { createLinkLines, LinkBuilderProps, LinkStyle } from './util/link.ts';
...
export function getInterUnitBondLineBuilderProps(
    ...
    return {
        ...
        referencePosition: (edgeIndex: number) => {
            ...
            return setRefPosition(ref, structure, unitA, indexA) ||
                setRefPosition(ref, structure, unitB, indexB);
        },
...
export function InterUnitBondLineVisual(
    materialId: number,
): ComplexVisual<InterUnitBondLineParams> {
