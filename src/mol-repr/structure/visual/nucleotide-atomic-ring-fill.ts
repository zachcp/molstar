...
export const DefaultNucleotideAtomicRingFillMeshProps = PD.getDefaultValues(
...
const stripIndicesRing5_6 = new Uint32Array([
    0,
    1,
    2,
    3,
                ...
                if (hasSugarIndices(idx)) {
                    ...
                    Vec3.scale(
                        ...
                        Vec3.add(
                            mid,
                            pO4_1,
                            Vec3.add(mid, pC4_1, Vec3.add(mid, pC3_1, Vec3.add(mid, pC1_1, pC2_1))),
                        ),
                        0.2, /* 1 / 5 */
                    );
...
export function NucleotideAtomicRingFillVisual(
    materialId: number,
): UnitsVisual<NucleotideAtomicRingFillParams> {
