...
import { computeUnitMolecularSurface, MolecularSurfaceProps } from './util/molecular-surface.ts';
...
export function MolecularSurfaceWireframeVisual(
    materialId: number,
): UnitsVisual<MolecularSurfaceWireframeParams> {
