...
function getIntraUnitBondCylinderBuilderProps(
    unit: Unit.Atomic,
    structure: Structure,
    theme: Theme,
    props: PD.Values<IntraUnitBondCylinderParams>,
): LinkBuilderProps {
    ...
    if (props.includeParent && child) {
        ...
        stub = (edgeIndex: number) => {
            ...
            return SortedArray.has(childUnit.elements, eA) &&
                !SortedArray.has(childUnit.elements, eB);
        };
    }
    ...
    return {
        ...
        referencePosition: (edgeIndex: number) => {
            ...
            for (let i = offset[aI], il = offset[aI + 1]; i < il; ++i) {
                ...
                if (_bI !== bI && _bI !== aI) {
                    if (aR) {
                        const _bR = elementAromaticRingIndices.get(_bI) ||
                            elementRingIndices.get(_bI);
                        if (!_bR) continue;
        ...
        style: (edgeIndex: number) => {
            ...
            if (
                isBondType(f, BondType.Flag.MetallicCoordination) ||
                isBondType(f, BondType.Flag.HydrogenBond)
            ) {
...
function createIntraUnitBondCylinderImpostors(
    ctx: VisualContext,
    unit: Unit,
    structure: Structure,
    theme: Theme,
    ...
    const { cylinders: c, boundingSphere } = createLinkCylinderImpostors(
        ctx,
        builderProps,
        props,
        cylinders,
...
function createIntraUnitBondCylinderMesh(
    ctx: VisualContext,
    unit: Unit,
    structure: Structure,
    theme: Theme,
...
export function IntraUnitBondCylinderVisual(
    materialId: number,
    structure: Structure,
    props: PD.Values<IntraUnitBondCylinderParams>,
    webgl?: WebGLContext,
...
export function IntraUnitBondCylinderImpostorVisual(
    materialId: number,
): UnitsVisual<IntraUnitBondCylinderParams> {
    return UnitsCylindersVisual<IntraUnitBondCylinderParams>({
        ...
        createLocationIterator: (structureGroup: StructureGroup, props) =>
            BondIterator.fromGroup(structureGroup, {
                includeLocation2: props.colorMode === 'interpolate',
            }),
        getLoci: getIntraBondLoci,
        eachLocation: eachIntraBond,
        setUpdateState: (
            state: VisualUpdateState,
            newProps: PD.Values<IntraUnitBondCylinderParams>,
            currentProps: PD.Values<IntraUnitBondCylinderParams>,
            newTheme: Theme,
            currentTheme: Theme,
...
export function IntraUnitBondCylinderMeshVisual(
    materialId: number,
): UnitsVisual<IntraUnitBondCylinderParams> {
...
function getStructureIntraUnitBondCylinderBuilderProps(
    structure: Structure,
    theme: Theme,
    props: PD.Values<StructureIntraUnitBondCylinderParams>,
): LinkBuilderProps {
...
function createStructureIntraUnitBondCylinderImpostors(
    ctx: VisualContext,
    structure: Structure,
    theme: Theme,
    props: PD.Values<StructureIntraUnitBondCylinderParams>,
...
function createStructureIntraUnitBondCylinderMesh(
    ctx: VisualContext,
    structure: Structure,
    theme: Theme,
    props: PD.Values<StructureIntraUnitBondCylinderParams>,
...
export function StructureIntraUnitBondCylinderVisual(
    materialId: number,
    structure: Structure,
    props: PD.Values<StructureIntraUnitBondCylinderParams>,
    webgl?: WebGLContext,
...
export function StructureIntraUnitBondCylinderImpostorVisual(
    materialId: number,
): ComplexVisual<StructureIntraUnitBondCylinderParams> {
    return ComplexCylindersVisual<StructureIntraUnitBondCylinderParams>({
        ...
        setUpdateState: (
            state: VisualUpdateState,
            newProps: PD.Values<StructureIntraUnitBondCylinderParams>,
            currentProps: PD.Values<StructureIntraUnitBondCylinderParams>,
            newTheme: Theme,
            currentTheme: Theme,
...
export function StructureIntraUnitBondCylinderMeshVisual(
    materialId: number,
): ComplexVisual<StructureIntraUnitBondCylinderParams> {
