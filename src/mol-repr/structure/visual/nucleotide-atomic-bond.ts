...
export function NucleotideAtomicBondVisual(
    materialId: number,
    structure: Structure,
    props: PD.Values<NucleotideAtomicBondParams>,
    webgl?: WebGLContext,
) {
...
function createNucleotideAtomicBondImpostor(
    ctx: VisualContext,
    unit: Unit,
    structure: Structure,
    theme: Theme,
    props: NucleotideAtomicBondImpostorProps,
    cylinders?: Cylinders,
) {
...
export function NucleotideAtomicBondImpostorVisual(
    materialId: number,
): UnitsVisual<NucleotideAtomicBondParams> {
    return UnitsCylindersVisual<NucleotideAtomicBondParams>({
        ...
        setUpdateState: (
            ...
            newProps: PD.Values<NucleotideAtomicBondParams>,
            currentProps: PD.Values<NucleotideAtomicBondParams>,
        ) => {
...
function createNucleotideAtomicBondMesh(
    ctx: VisualContext,
    unit: Unit,
    structure: Structure,
    theme: Theme,
    props: NucleotideAtomicBondMeshProps,
    mesh?: Mesh,
) {
...
export function NucleotideAtomicBondMeshVisual(
    materialId: number,
): UnitsVisual<NucleotideAtomicBondParams> {
