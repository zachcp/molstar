...
import { Representation, type RepresentationProps, type RepresentationProvider } from '../representation.ts';
...
export type StructureRepresentationProvider<P extends PD.Params, Id extends string = string> = RepresentationProvider<
    Structure,
    P,
