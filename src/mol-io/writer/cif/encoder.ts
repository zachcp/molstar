...
export namespace Field {
  ...
  export function str<K, D = any>(
    ...
    return {
      ...
      defaultFormat:
        params && params.encoder ? { encoder: params.encoder } : void 0,
    ...
    return {
      ...
      defaultFormat: params
        ? {
            ...
            digitCount:
              typeof params.digitCount !== "undefined"
                ? params.digitCount
                : void 0,
          }
        : void 0,
...
export interface Encoder<T = string | Uint8Array<ArrayBuffer>>
  extends EncoderBase {
...
function getTensorDefinitions(field: string, space: Tensor.Space) {
  ...
  if (space.rank === 1) {
    ...
    throw new Error(
      "Tensors with rank > 3 or rank 0 are currently not supported.",
    );
  }
