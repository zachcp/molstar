...
import { TypedFloatArray, TypedIntArray } from '../../../mol-util/type-helpers.ts';
...
export namespace ArrayEncoding {
    ...
    export function intervalQuantizaiton(
        ...
        return (data) =>
            _intervalQuantizaiton(data as TypedFloatArray, min, max, numSteps, arrayType);
    }
    ...
    function determinePacking(
        data: Int32Array,
    ): { isSigned: boolean; size: number; bytesPerElement: number } {
