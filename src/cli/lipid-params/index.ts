...
const MARTINI_LIPIDS_URL =
    'https://cgmartini-library.s3.ca-central-1.amazonaws.com/1_Downloads/ff_parameters/martini3/martini_v3.0.0_phospholipids_v1.itp';
...
async function ensureLipidsAvailable() {
    await ensureAvailable(MARTINI_LIPIDS_PATH, MARTINI_LIPIDS_URL);
}
