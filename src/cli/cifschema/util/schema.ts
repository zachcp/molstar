...
export function IntCol(description: string): IntCol {
    return { type: 'int', description };
}

export type StrCol = { type: 'str' } & BaseCol;
export function StrCol(description: string): StrCol {
    return { type: 'str', description };
}

export type FloatCol = { type: 'float' } & BaseCol;
export function FloatCol(description: string): FloatCol {
    return { type: 'float', description };
}

export type CoordCol = { type: 'coord' } & BaseCol;
export function CoordCol(description: string): CoordCol {
    return { type: 'coord', description };
}

export type EnumCol =
    & { type: 'enum'; subType: 'int' | 'str' | 'ustr' | 'lstr'; values: string[] }
    & BaseCol;
