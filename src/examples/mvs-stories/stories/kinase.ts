...
`,
        state: () => {
            ...
            domains(_2g2i, _2g2i_poly_repr, [
                ...
                [Domains.Activation_loop, DomainColors['Activation_loop'], 'Activation Loop (active)', {
                    label_size: 3,
                }],
            ], { label_size: 3 });
...
`,
        state: () => {
            ...
            domains(_1iep, _1iep_poly_repr, [
                [Domains.P_loop, DomainColors['P_loop'], 'P Loop'],
                [Domains.Activation_loop, DomainColors['Activation_loop'], 'Activation Loop (inactive)', {
                    label_size: 3,
                }],
            ], { label_size: 3 });
...
function domains(
    ...
    domains: [selector: ComponentExpressionT, color: ColorT, label?: string, options?: { label_size?: number }][],
