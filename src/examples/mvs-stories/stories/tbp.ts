...
The crystal structure of TBP from *Arabidopsis thaliana* in its apo form is shown ([PDB ID 1VOK](${
            wwPDBLink('1vok')
        })).
...
`,
        state: () => {
            ...
            select(_1cdw, { color: Colors['1cdw'], selector: 'nucleic', opacity: 0.5 })[0].label({
                text: 'DNA',
            });
...
`,
        state: () => {
            ...
            select(_7enc, { color: Colors['7enc'], selector: { label_asym_id: 'CB' } })[0].label({
                text: 'TBP',
            });
