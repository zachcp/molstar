...
import type { Renderable, RenderableState } from './renderable.ts';
import { idFactory } from '../mol-util/id-factory.ts';
import type { WebGLContext } from './webgl/context.ts';
import { DirectVolumeRenderable, type DirectVolumeValues } from './renderable/direct-volume.ts';
import { MeshRenderable, type MeshValues } from './renderable/mesh.ts';
import { PointsRenderable, type PointsValues } from './renderable/points.ts';
import { LinesRenderable, type LinesValues } from './renderable/lines.ts';
import { SpheresRenderable, type SpheresValues } from './renderable/spheres.ts';
import { TextRenderable, type TextValues } from './renderable/text.ts';
import { TextureMeshRenderable, type TextureMeshValues } from './renderable/texture-mesh.ts';
import { ImageRenderable, type ImageValues } from './renderable/image.ts';
...
export function createRenderable<T extends RenderObjectType>(
    ...
    switch (o.type) {
        case 'mesh':
            return MeshRenderable(ctx, o.id, o.values as MeshValues, o.state, o.materialId, transparency, globals);
        case 'points':
            return PointsRenderable(ctx, o.id, o.values as PointsValues, o.state, o.materialId, transparency, globals);
        case 'spheres':
        ...
        case 'text':
            return TextRenderable(ctx, o.id, o.values as TextValues, o.state, o.materialId, transparency, globals);
        case 'lines':
            return LinesRenderable(ctx, o.id, o.values as LinesValues, o.state, o.materialId, transparency, globals);
        case 'direct-volume':
        ...
        case 'image':
            return ImageRenderable(ctx, o.id, o.values as ImageValues, o.state, o.materialId, transparency, globals);
        case 'texture-mesh':
