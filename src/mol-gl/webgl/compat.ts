...
export function getVertexArrayObject(
    ...
    if (isWebGL2(gl)) {
        return {
            ...
            isVertexArray: (value: any): value is WebGLVertexArrayObject => gl.isVertexArray(value) === true,
        };
    } else {
        ...
        return {
            ...
            isVertexArray: (value: any): value is WebGLVertexArrayObject => ext.isVertexArrayOES(value) === true,
        };
    }
}
...
export function getDisjointTimerQuery(
    ...
    if (isWebGL2(gl)) {
        ...
        return {
            ...
            getQuery: (target: number, pname: number) => gl.getQuery(target, pname) ?? 0,
        ...
        return {
            ...
            queryCounter: ext.queryCounterEXT.bind(ext),
            getQuery: (target: number, pname: number) => ext.getQueryEXT(target, pname) ?? 0,
