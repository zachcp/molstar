...
import {
    type COMPAT_blend_minmax,
    type COMPAT_clip_control,
    type COMPAT_clip_cull_distance,
    type COMPAT_color_buffer_float,
    type COMPAT_color_buffer_half_float,
    type COMPAT_conservative_depth,
    type COMPAT_depth_clamp,
    type COMPAT_depth_texture,
    type COMPAT_disjoint_timer_query,
    type COMPAT_draw_buffers,
    type COMPAT_draw_buffers_indexed,
    type COMPAT_draw_instanced_base_vertex_base_instance,
    type COMPAT_element_index_uint,
    type COMPAT_fboRenderMipmap,
    type COMPAT_frag_depth,
    type COMPAT_instanced_arrays,
    type COMPAT_multi_draw,
    type COMPAT_multi_draw_instanced_base_vertex_base_instance,
    type COMPAT_multiview2,
    type COMPAT_parallel_shader_compile,
    type COMPAT_provoking_vertex,
    type COMPAT_render_shared_exponent,
    type COMPAT_render_snorm,
    type COMPAT_shader_texture_lod,
    type COMPAT_sRGB,
    type COMPAT_standard_derivatives,
    type COMPAT_stencil_texturing,
    type COMPAT_texture_float,
    type COMPAT_texture_float_linear,
    type COMPAT_texture_half_float,
    type COMPAT_texture_half_float_linear,
    type COMPAT_texture_norm16,
    type COMPAT_vertex_array_object,
    getBlendMinMax,
    getClipControl,
    getClipCullDistance,
    getColorBufferFloat,
    getColorBufferHalfFloat,
    getConservativeDepth,
    getDepthClamp,
    getDepthTexture,
    ...
    getInstancedArrays,
    getMultiDraw,
    getMultiDrawInstancedBaseVertexBaseInstance,
    getMultiview2,
    getNoNonInstancedActiveAttribs,
    getParallelShaderCompile,
    getProvokingVertex,
    getRenderSharedExponent,
    getRenderSnorm,
    getShaderTextureLod,
    getSRGB,
