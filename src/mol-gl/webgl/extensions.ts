...
export function createExtensions(gl: GLRenderingContext): WebGLExtensions {
    ...
    const multiDrawInstancedBaseVertexBaseInstance = getMultiDrawInstancedBaseVertexBaseInstance(
        gl,
    );
