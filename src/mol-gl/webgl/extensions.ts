...
import { type GLRenderingContext, type COMPAT_instanced_arrays, type COMPAT_standard_derivatives, type COMPAT_vertex_array_object, getInstancedArrays, getStandardDerivatives, type COMPAT_element_index_uint, getElementIndexUint, type COMPAT_texture_float, getTextureFloat, type COMPAT_texture_float_linear, getTextureFloatLinear, type COMPAT_blend_minmax, getBlendMinMax, getFragDepth, type COMPAT_frag_depth, type COMPAT_color_buffer_float, getColorBufferFloat, type COMPAT_draw_buffers, getDrawBuffers, getShaderTextureLod, type COMPAT_shader_texture_lod, getDepthTexture, type COMPAT_depth_texture, type COMPAT_sRGB, getSRGB, getTextureHalfFloat, getTextureHalfFloatLinear, type COMPAT_texture_half_float, type COMPAT_texture_half_float_linear, type COMPAT_color_buffer_half_float, getColorBufferHalfFloat, getVertexArrayObject, getDisjointTimerQuery, type COMPAT_disjoint_timer_query, getNoNonInstancedActiveAttribs, type COMPAT_multi_draw, getMultiDraw, getDrawInstancedBaseVertexBaseInstance, getMultiDrawInstancedBaseVertexBaseInstance, type COMPAT_draw_instanced_base_vertex_base_instance, type COMPAT_multi_draw_instanced_base_vertex_base_instance, getDrawBuffersIndexed, type COMPAT_draw_buffers_indexed, getParallelShaderCompile, type COMPAT_parallel_shader_compile, getFboRenderMipmap, type COMPAT_fboRenderMipmap, type COMPAT_provoking_vertex, getProvokingVertex, type COMPAT_clip_cull_distance, getClipCullDistance, type COMPAT_conservative_depth, getConservativeDepth, type COMPAT_stencil_texturing, getStencilTexturing, type COMPAT_clip_control, getClipControl, getRenderSnorm, type COMPAT_render_snorm, getRenderSharedExponent, type COMPAT_render_shared_exponent, getTextureNorm16, type COMPAT_texture_norm16, getDepthClamp, type COMPAT_depth_clamp, type COMPAT_multiview2, getMultiview2 } from './compat.ts';
