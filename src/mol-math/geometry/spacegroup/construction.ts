...
import { SymmetryOperator } from '../symmetry-operator.ts';
...
namespace SpacegroupCell {
    ...
    export function create(
        ...
        if (index < 0) {
            console.warn(
                `Unknown spacegroup '${nameOrNumber}', returning a 'P 1' with cellsize [1, 1, 1]`,
            );
            return Zero;
        }
...
namespace Spacegroup {
    ...
    export function getSymmetryOperator(
        ...
        return SymmetryOperator.create(
            SymmetryOperator.getSymmetryOperatorName(spgrOp, i, j, k),
            operator,
            { hkl: Vec3.create(i, j, k), spgrOp },
        );
    }
    ...
    export function getSymmetryOperatorRef(
        ...
        return SymmetryOperator.create(
            SymmetryOperator.getSymmetryOperatorName(spgrOp, _i, _j, _k),
            operator,
            { hkl: Vec3.create(_i, _j, _k), spgrOp },
        );
    }
