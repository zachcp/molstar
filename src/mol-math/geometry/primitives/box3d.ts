...
namespace Box3D {
  ...
  export function intersectsSphere3D(box: Box3D, sphere: Sphere3D): boolean {
    ...
    return (
      Vec3.squaredDistance(tmpV, sphere.center) <= sphere.radius * sphere.radius
    );
  }
  ...
  export function expandUniformly(
    out: Box3D,
    box: Box3D,
    delta: number,
  ): Box3D {
  ...
  export function transform(out: Box3D, box: Box3D, m: Mat4): Box3D {
    ...
    add(
      ...
      Vec3.transformMat4(
        tmpTransformV,
        Vec3.set(tmpTransformV, minX, minY, minZ),
        m,
      ),
    );
    add(
      ...
      Vec3.transformMat4(
        tmpTransformV,
        Vec3.set(tmpTransformV, minX, minY, maxZ),
        m,
      ),
    );
    add(
      ...
      Vec3.transformMat4(
        tmpTransformV,
        Vec3.set(tmpTransformV, minX, maxY, minZ),
        m,
      ),
    );
    add(
      ...
      Vec3.transformMat4(
        tmpTransformV,
        Vec3.set(tmpTransformV, minX, maxY, maxZ),
        m,
      ),
    );
    add(
      ...
      Vec3.transformMat4(
        tmpTransformV,
        Vec3.set(tmpTransformV, maxX, minY, minZ),
        m,
      ),
    );
    add(
      ...
      Vec3.transformMat4(
        tmpTransformV,
        Vec3.set(tmpTransformV, maxX, minY, maxZ),
        m,
      ),
    );
    add(
      ...
      Vec3.transformMat4(
        tmpTransformV,
        Vec3.set(tmpTransformV, maxX, maxY, minZ),
        m,
      ),
    );
    add(
      ...
      Vec3.transformMat4(
        tmpTransformV,
        Vec3.set(tmpTransformV, maxX, maxY, maxZ),
        m,
      ),
    );
    return out;
