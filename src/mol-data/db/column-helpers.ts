...
export function getArrayBounds(rowCount: number, params?: Column.ToArrayParams<any>): { start: number, end: number } {
...
export function createArray(rowCount: number, params?: Column.ToArrayParams<any>): { array: any[], start: number, end: number } {
