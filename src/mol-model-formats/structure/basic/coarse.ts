...
import { CoarseHierarchy, CoarseConformation, CoarseElementData, CoarseSphereConformation, CoarseGaussianConformation } from '../../../mol-model/structure/model/properties/coarse.ts';
...
import { ElementIndex, ChainIndex } from '../../../mol-model/structure/model/indexing.ts';
import { getCoarseRanges } from '../../../mol-model/structure/model/properties/utils/coarse-ranges.ts';
import { IhmSphereObjSite, IhmGaussianObjSite, AtomSite, BasicSchema } from './schema.ts';
