...
import { ChainIndex, ElementIndex } from '../../../mol-model/structure/model/indexing.ts';
import { getCoarseRanges } from '../../../mol-model/structure/model/properties/utils/coarse-ranges.ts';
import { AtomSite, BasicSchema, IhmGaussianObjSite, IhmSphereObjSite } from './schema.ts';
