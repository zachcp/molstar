...
namespace StateSelection {
  ...
  > {
    return unique(
      mapObject(b, (n, s) =>
        findAncestor(s.tree, s.cells, n.transform.ref, test),
      ),
    );
  }
  ...
  > {
    return unique(
      mapObject(b, (n, s) =>
        findAncestorOfType(s.tree, s.cells, n.transform.ref, types),
      ),
    );
  }
  ...
  > {
    return unique(
      mapObject(b, (n, s) =>
        findRootOfType(s.tree, s.cells, n.transform.ref, types),
      ),
    );
  }
  ...
  > {
    return unique(
      mapObject(b, (n, s) =>
        s.cells.get(s.tree.transforms.get(n.transform.ref)!.parent),
      ),
    );
  }
