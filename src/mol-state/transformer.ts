...
import type { StateTreeSpine } from './tree/spine.ts';
...
namespace Transformer {
    ...
    export type Cell<T extends Transformer<any, any, any>> = T extends Transformer<any, infer B, any>
        ? StateObjectCell<B>
        : unknown;
    ...
    export function create<A extends StateObject, B extends StateObject, P extends {} = {}>(
        ...
        const t: Transformer<A, B, P> = {
            ...
            createDefaultParams(a, globalCtx) {
                return definition.params ? PD.getDefaultValues(definition.params(a, globalCtx)) : {} as any;
            },
        };
        registry.set(id, t);
        _index(t);
