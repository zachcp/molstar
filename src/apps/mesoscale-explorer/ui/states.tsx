...
import { ExampleEntry, MesoscaleExplorerState } from '../app.ts';
...
export class ExplorerInfo
    extends PluginUIComponent<{}, { isDisabled: boolean; showHelp: boolean }> {
    state = {
        isDisabled: false,
        showHelp: false,
    };
        ...
        driver.setSteps([
            ...
            },
            {
                ...
                popover: {
                    ...
                    description:
                        'Load local files (.molx, .molj, .zip, .cif, .bcif) using this option.',
                    side: 'bottom',
                    align: 'start',
                },
            },
            ...
            },
            {
                ...
                popover: {
                    ...
                    description:
                        'Create movies or scenes with rocking, rotating, or snapshots animations.',
                    side: 'right',
                    align: 'start',
                },
            },
            ...
            },
            {
                ...
                popover: {
                    ...
                    description:
                        'Control the visibility and text size of the snapshot description widget.',
                    side: 'right',
                    align: 'start',
                },
            },
            ...
            },
            {
                ...
                popover: {
                    ...
                    description:
                        'Detailed information about the current selection, if present in the loaded file.',
                    side: 'right',
                    align: 'start',
                },
            },
            {
                popover: {
                    ...
                    description:
                        'That’s all! Go ahead and start exploring or creating mesoscale tours.',
                },
            },
        ]);
        driver.refresh();
