...
export { consoleStats, isDebugMode, isProductionMode, isTimingMode, setDebugMode, setProductionMode, setTimingMode } from '../../mol-util/debug.ts';

import '../../mol-util/polyfill';
import { ViewerAutoPreset } from './presets.ts';
