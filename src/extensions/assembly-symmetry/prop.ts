...
import { Model, QueryContext, type Structure, StructureSelection } from '../../mol-model/structure.ts';
...
export const AssemblySymmetryProvider: CustomStructureProperty.Provider<AssemblySymmetryParams, AssemblySymmetryValue> =
    CustomStructureProperty.createProvider({
