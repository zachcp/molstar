...
import type { Model, ResidueIndex } from '../../../mol-model/structure/model.ts';
import type { AtomicIndex } from '../../../mol-model/structure/model/properties/atomic.ts';
...
namespace QualityAssessment {
    ...
    export function pairwiseMetricFromModelArchiveCIF(
        ...
        const { model_id, label_asym_id_1, label_seq_id_1, label_asym_id_2, label_seq_id_2, metric_id, metric_value } =
...
export const QualityAssessmentProvider: CustomModelProperty.Provider<QualityAssessmentParams, QualityAssessment> =
