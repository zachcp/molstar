...
function getPoints(
    loc: StructureElement.Location,
    r0: DnatcoUtil.Residue | undefined,
    r1: DnatcoUtil.Residue,
    r2: DnatcoUtil.Residue,
    altId0: string,
    altId1: string,
    altId2: string,
    insCode0: string,
...
export class NtCTubeSegmentsIterator {
    ...
    private moveStep() {
        ...
        if (this.residueTwo.index + 1 === this.residueNext.index) {
            ...
            this.residueNext = this.residueIt.hasNext
                ? DnatcoUtil.copyResidue(this.residueIt.move())!
                : void 0;
        } else {
    ...
    private toSegment(
        ...
        r1: DnatcoUtil.Residue,
        r2: DnatcoUtil.Residue,
        r3: DnatcoUtil.Residue | undefined,
    ): NtCTubeSegment | undefined {
        ...
        const followsGap = !!r0 && hasGapElements(r0, this.loc.unit) &&
            hasGapElements(r1, this.loc.unit);
    ...
    constructor(structure: Structure, unit: Unit.Atomic) {
        this.chainIt = Segmentation.transientSegments(
    ...
    get hasNext() {
        ...
        return !!this.residueNext ? true : this.chainIt.hasNext;
    }
