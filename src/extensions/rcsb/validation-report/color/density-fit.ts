...
import { Bond, ElementIndex, Model, StructureElement } from '../../../../mol-model/structure.ts';
...
> = {
    ...
    isApplicable: (ctx: ThemeDataContext) =>
        ...
        Model.isFromXray(ctx.structure.models[0]) &&
        Model.probablyHasDensityMap(ctx.structure.models[0]),
