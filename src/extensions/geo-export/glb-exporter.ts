...
import { AddMeshInput, MeshExporter, MeshGeoData } from './mesh-exporter.ts';
...
export class GlbExporter extends MeshExporter<GlbData> {
    ...
    private addGeometryBuffers(
        ...
        return {
            ...
            normalAccessorIndex: normalBuffer
                ...
                : undefined,
            indexAccessorIndex: (isGeoTexture || !indexBuffer) ? undefined : this.addBuffer(
                indexBuffer,
                UNSIGNED_INT,
                'SCALAR',
                drawCount,
    ...
    protected async addMeshWithColors(input: AddMeshInput) {
        ...
        const sameColorBuffer = sameGeometryBuffers && colorType !== 'instance' &&
            !colorType.endsWith('Instance') && !dTransparency;
        ...
        for (let instanceIndex = 0; instanceIndex < instanceCount; ++instanceIndex) {
            ...
            if (instanceIndex === 0 || !sameGeometryBuffers || !sameColorBuffer) {
                const { vertices, normals, indices, groups, vertexCount, drawCount } = GlbExporter
