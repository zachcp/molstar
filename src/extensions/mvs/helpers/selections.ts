...
import { type ChainIndex, type ElementIndex, type Model, type ResidueIndex, StructureElement } from '../../../mol-model/structure.ts';
import type { CoarseElements } from '../../../mol-model/structure/model/properties/coarse.ts';
import type { Expression } from '../../../mol-script/language/expression.ts';
import { arrayExtend, filterInPlace, range, sortIfNeeded } from '../../../mol-util/array.ts';
import { ElementRanges } from './element-ranges.ts';
import { type AtomicIndicesAndSortings, type CoarseIndicesAndSortings, type IndicesAndSortings, Sorting } from './indexing.ts';
