...
const ScalarInterpolation = {
    ...
    start: OptionalField(
        nullable(union(float, list(float))),
        null,
        'Start value. If a list of values is provided, each element will be interpolated separately. If unset, parent state value is used.',
    ),
...
const ColorInterpolation = {
    ...
    /** Start value. If unset, parent state value is used. */
    start: OptionalField(
        union(nullable(ColorT), dict(union(int, str), ColorT)),
        null,
        'Start value. If unset, parent state value is used.',
    ),
    /** End value. */
    ...
    palette: OptionalField(
        nullable(union(DiscretePalette, ContinuousPalette)),
        null,
        'Palette to sample colors from. Overrides start and end values.',
    ),
};
...
const TransformationMatrixInterpolation = {
    ...
    rotation_frequency: OptionalField(
        int,
        1,
        'Determines how many times the rotation interpolation loops. Current T = frequency * t mod 1.',
    ),
    /** Whether to alternate the direction of the interpolation for frequency > 1. */
    rotation_alternate_direction: OptionalField(
        bool,
        false,
        'Whether to alternate the direction of the interpolation for frequency > 1.',
    ),
    /** Start translation value. If unset, parent state value is used. */
    translation_start: OptionalField(
        nullable(Vector3),
        null,
        'Start translation value. If unset, parent state value is used.',
    ),
    ...
    translation_frequency: OptionalField(
        int,
        1,
        'Determines how many times the translation interpolation loops. Current T = frequency * t mod 1.',
    ),
    /** Whether to alternate the direction of the interpolation for frequency > 1. */
    translation_alternate_direction: OptionalField(
        bool,
        false,
        'Whether to alternate the direction of the interpolation for frequency > 1.',
    ),
    ...
    scale_frequency: OptionalField(
        int,
        1,
        'Determines how many times the scale interpolation loops. Current T = frequency * t mod 1.',
    ),
    /** Whether to alternate the direction of the interpolation for frequency > 1. */
    scale_alternate_direction: OptionalField(
        bool,
        false,
        'Whether to alternate the direction of the interpolation for frequency > 1.',
    ),
...
export type MVSAnimationNode<TKind extends MVSAnimationKind = MVSAnimationKind> = NodeFor<
    typeof MVSAnimationSchema,
    TKind
>;
...
export type MVSAnimationSubtree<TKind extends MVSAnimationKind = MVSAnimationKind> = SubtreeOfKind<
    MVSAnimationTree,
    TKind
>;
