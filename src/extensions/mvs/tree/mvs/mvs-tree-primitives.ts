...
const ArrowParams = {
    ...
    /** Length of each dash and gap between dashes. If not specified (null), draw full line. */
    tube_dash_length: OptionalField(
        nullable(float),
        null,
        'Length of each dash and gap between dashes. If not specified (null), draw full line.',
    ),
