...
} from './mvs-tree-representations.ts';
...
const LabelAttachments = literal(
    'bottom-left',
    'bottom-center',
    'bottom-right',
    'middle-left',
    ...
    nodes: {
        ...
        component: {
            ...
            params: SimpleParamsSchema({
                ...
                selector: RequiredField(
                    union(ComponentSelectorT, ComponentExpressionT, list(ComponentExpressionT)),
                    'Defines what part of the parent structure should be included in this component.',
                ),
            }),
        },
        ...
        canvas: {
            ...
            params: SimpleParamsSchema({
                ...
                background_color: RequiredField(
                    ColorT,
                    'Color of the canvas background. Can be either an X11 color name (e.g. `"red"`) or a hexadecimal code (e.g. `"#FF0011"`).',
                ),
            }),
        ...
        primitives: {
            ...
            params: SimpleParamsSchema({
                ...
                label_color: OptionalField(
                    ColorT,
                    'white',
                    'Default label color for primitives in this group.',
                ),
                /** Default tooltip for primitives in this group. */
                tooltip: OptionalField(
                    nullable(str),
                    null,
                    'Default tooltip for primitives in this group.',
                ),
