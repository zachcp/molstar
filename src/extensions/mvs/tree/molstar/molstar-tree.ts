...
import { bool, RequiredField } from '../generic/field-schema.ts';
    ...
    nodes: {
        ...
        structure: {
            ...
            params: SimpleParamsSchema(
                omitObjectKeys(
                    FullMVSTreeSchema.nodes.structure.params.fields,
                    ['block_header', 'block_index', 'model_index'] as const,
                ),
            ),
        },
    },
...
export type MolstarNode<TKind extends MolstarKind = MolstarKind> = NodeFor<
    typeof MolstarTreeSchema,
    TKind
>;
...
export type MolstarSubtree<TKind extends MolstarKind = MolstarKind> = SubtreeOfKind<
    MolstarTree,
    TKind
>;
