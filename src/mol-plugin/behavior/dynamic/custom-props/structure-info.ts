...
import { type StateObject, StateSelection, type StateTransformer } from '../../../../mol-state/index.ts';

export const StructureInfo: StateTransformer<PluginBehavior.Category, PluginBehavior.Behavior, {}> = PluginBehavior.create({
