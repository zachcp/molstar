...
export const PLUGIN_VERSION = typeof __MOLSTAR_PLUGIN_VERSION__ !== 'undefined'
    ? __MOLSTAR_PLUGIN_VERSION__
    : '(development)';

/** to be filled in at build time */
export const PLUGIN_VERSION_DATE = new Date(
    typeof __MOLSTAR_BUILD_TIMESTAMP__ !== 'undefined' ? +__MOLSTAR_BUILD_TIMESTAMP__ : Date.now(),
);
