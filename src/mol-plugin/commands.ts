...
import type { State, StateAction, StateTransform } from '../mol-state/index.ts';
...
import type { PluginToast } from './util/toast.ts';
...
export const PluginCommands = {
    State: {
        ...
        Update: PluginCommand<
            { state: State; tree: State.Tree | State.Builder; options?: Partial<State.UpdateOptions> }
        >(),
        ...
        Snapshots: {
            ...
            DownloadToFile: PluginCommand<
                { name?: string; type: PluginState.SnapshotType; params?: PluginState.SnapshotParams }
            >(),
