...
import { State, StateAction, StateTransform } from '../mol-state/index.ts';
...
export const PluginCommands = {
    State: {
        ...
        ApplyAction: PluginCommand<
            { state: State; action: StateAction.Instance; ref?: StateTransform.Ref }
        >(),
        ...
        RemoveObject: PluginCommand<
            { state: State; ref: StateTransform.Ref; removeParentGhosts?: boolean }
        >(),
    ...
    Interactivity: {
        Object: {
            Highlight: PluginCommand<
                { state: State; ref: StateTransform.Ref | StateTransform.Ref[] }
            >(),
        },
        Structure: {
